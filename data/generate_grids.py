...
# Grid-62
link_length62 = {1: 0, 2: 900, 3: 2700, 4: 1800, 5: 900, 6: 900, 7: 900,
               8: 900, 9: 900, 10: 900, 11: 2700, 12: 900, 13: 900, 14: 900,
               15: 900, 16: 1800, 17: 1800, 18: 900, 19: 2700, 20: 1800, 21: 900,
               22: 900, 23: 900, 24: 900, 25: 900, 26: 900, 27: 900, 28: 900,
               29: 900, 30: 900, 31: 900, 32: 900, 33: 2700, 34: 900, 35: 900,
               36: 900, 37: 900, 38: 900, 39: 1800, 40: 900, 41: 900, 42: 900,
               43: 900, 44: 2700, 45: 900, 46: 900, 47: 900, 48: 900, 49: 1800,
               50: 900, 51: 900, 52: 1800, 53: 900, 54: 900, 55: 900, 56: 900,
               57: 900, 58: 900, 59: 900, 60: 900, 61: 900, 62: 0}
...
edges62 = [
    ...
    (7, 15), (16, 24), (25, 33), (34, 40), (47, 48), # 3rd
    (9, 17), (18, 26), (27, 35), (36, 41), (49, 50), # 4th
    (10, 52), (19, 53), (28, 54), (37, 55), (42, 56), # 5th
    (1, 3), (3, 12), (12, 21), (21, 30), (30, 43), # 1st column
    (5, 14), (14, 23), (23, 32), (32, 45), # 2nd
    (7, 16), (16, 25), (25, 34), (34, 47), # 3rd
    (9, 18), (18, 27), (27, 36), (36, 49), # 4th
    (10, 19), (19, 28), (28, 37), (37, 42), # 5th
    (57, 58), (58, 59), (59, 60), (60, 61), (61, 62), # 6th
    (2, 4), (4, 6), (6, 8), (8, 51), # 1st row
    (11, 13), (13, 15), (15, 17), (17, 52), # 2nd
    (20, 22), (22, 24), (24, 26), (26, 53), # 3rd
    (29, 31), (31, 33), (33, 35), (35, 54), # 4th
    (38, 39), (39, 40), (40, 41), (41, 55), # 5th
    (44, 46), (46, 48), (48, 50), (50, 56), # 6th
    (2, 5), (4, 7), (6, 9), (8, 10), (51, 57), # 1st row-column (L tranposed shape)
    (11, 14), (13, 16), (15, 18), (17, 19), (52, 58), # 2nd
    (20, 23), (22, 25), (24, 27), (26, 28), (53, 59), # 3rd
    (29, 32), (31, 34), (33, 36), (35, 37), (54, 60), # 4rd
    (38, 45), (39, 47), (40, 49), (41, 42), (55, 61), # 5th
    (56, 62) # 6th
    ]

# Save as json file
with open("grid62.json", "w") as f:
    json.dump({"link_length": link_length62, "edges": edges62}, f, indent=2)
